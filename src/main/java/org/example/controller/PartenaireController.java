...
import org.example.entity.Partenaire;
...
// Définir la largeur du tableau en pourcentage de la largeur de la page
        ...
        table.addCell(new Cell().add(new Paragraph("Nom").addStyle(headerStyle))); // Couleur de fond personnalisée
        ...
        for (Partenaire partenaire : partenaires) {
            table.addCell(new Cell().add(new Paragraph(partenaire.getNom()).addStyle(cellStyle))); // Couleur de fond personnalisée
